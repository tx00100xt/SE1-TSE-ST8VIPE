...
components:
 ...
 12 model   MODEL_HUANMAN_P     "Models\\Enemies\\Huanman\\Projectile\\Projectile.mdl",
 13 texture TEXTURE_HUANMAN_P   "Models\\Enemies\\Huanman\\Projectile\\Projectile.tex",
 14 model   MODEL_HUANMAN_F     "Models\\Enemies\\Huanman\\Projectile\\Flare.mdl",
 15 texture TEXTURE_HUANMAN_WR  "Textures\\Effects\\Flares\\01\\WhiteRedRing66.tex",
...
functions:
  ...
  void Precache(void) {
    ...
    PrecacheModel(MODEL_HUANMAN_P);
    PrecacheTexture(TEXTURE_HUANMAN_P);
	PrecacheModel(MODEL_HUANMAN_F);
	PrecacheTexture(TEXTURE_HUANMAN_WR);
