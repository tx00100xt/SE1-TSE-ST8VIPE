...
//#include "Models/Effects/DBExplosion/Explosion.h"
...
// 51 BET_SNIPER_RESIDUE          "Sniper Residue",		// smoke left after firing sniper
 ...
 60 BET_EXPLOSION01             "Explosion01",
 61 BET_EXPLOSION02             "Explosion02",
 62 BET_EXPLOSION03             "Explosion03",
 63 BET_EXPLOSION04             "Explosion04",
 64 BET_PLANE_EXPLOSION01       "Plane Explosion01",
 65 BET_PLANE_EXPLOSION02       "Plane Explosion02",
 66 BET_PLANE_EXPLOSION03       "Plane Explosion03",
 67 BET_PLANE_EXPLOSION04       "Plane Explosion04",
 68 BET_KNIFE_IMPACT            "Knife Projectile Impact",
 69 BET_DB_EXPLOSION            "Da Bomb Explosion",
 70 BET_CANNONSHOCKWAVE_VERT		"Cannon shockwave Vertical",	 
 71 BET_NUKE_EXPLOSION					"Nuke Explosion",	 
 72 BET_EXPLOSION_DEBRIS2				"Simple Explosion Debris",
 73 BET_IMPLOSION								"Spawn Implosion",
 74 BET_KAMI_EXPLOSION					"Kamikaze Explosion",
};
...
void CBasicEffect_OnPrecache(CDLLEntityClass *pdec, INDEX iUser) 
{
  ...
  case BET_TELEPORT:
    ...
    break;
  case BET_EXPLOSION01:
		pdec->PrecacheModel(MDL_EXPLOSION01);
		pdec->PrecacheTexture(TXT_EXPLOSION01);
    pdec->PrecacheSound(SOUND_EXPLOSION);
	break;
  case BET_EXPLOSION02:
		pdec->PrecacheModel(MDL_EXPLOSION02);
		pdec->PrecacheTexture(TXT_EXPLOSION02);
    pdec->PrecacheSound(SOUND_EXPLOSION);
	break;
  case BET_EXPLOSION03:
		pdec->PrecacheModel(MDL_EXPLOSION03);
		pdec->PrecacheTexture(TXT_EXPLOSION03);
    pdec->PrecacheSound(SOUND_EXPLOSION);
	break;
  case BET_EXPLOSION04:
		pdec->PrecacheModel(MDL_EXPLOSION04);
		pdec->PrecacheTexture(TXT_EXPLOSION04);
    pdec->PrecacheSound(SOUND_EXPLOSION);
	break;
  case BET_PLANE_EXPLOSION01:
		pdec->PrecacheModel(MDL_PLANE_EXPLOSION01);
		pdec->PrecacheTexture(TXT_EXPLOSION01);
    pdec->PrecacheSound(SOUND_EXPLOSION);
	break;
  case BET_PLANE_EXPLOSION02:
		pdec->PrecacheModel(MDL_PLANE_EXPLOSION02);
		pdec->PrecacheTexture(TXT_EXPLOSION02);
    pdec->PrecacheSound(SOUND_EXPLOSION);
	break;
  case BET_PLANE_EXPLOSION03:
		pdec->PrecacheModel(MDL_PLANE_EXPLOSION03);
		pdec->PrecacheTexture(TXT_EXPLOSION03);
    pdec->PrecacheSound(SOUND_EXPLOSION);
	break;
  case BET_PLANE_EXPLOSION04:
		pdec->PrecacheModel(MDL_PLANE_EXPLOSION04);
		pdec->PrecacheTexture(TXT_EXPLOSION04);
    pdec->PrecacheSound(SOUND_EXPLOSION);
	break;
  case BET_KNIFE_IMPACT:
    pdec->PrecacheModel(MODEL_BULLET_HIT);
		pdec->PrecacheTexture(TEXTURE_KNIFE_IMPACT);
	break;
  case BET_DB_EXPLOSION:
		pdec->PrecacheModel(MDL_DB_EXPLOSION);
		pdec->PrecacheTexture(TXT_DB_EXPLOSION);
    pdec->PrecacheSound(SOUND_DB_EXPLOSION);
	break;
  case BET_NUKE_EXPLOSION:
		pdec->PrecacheModel(MDL_NUKE_EXPLOSION);
		pdec->PrecacheTexture(TXT_NUKE_EXPLOSION);
    pdec->PrecacheSound(SOUND_NUKE_EXPLOSION);
	break;
  case BET_IMPLOSION:
    pdec->PrecacheModel(MODEL_BULLET_HIT);
    pdec->PrecacheTexture(TEXTURE_BULLET_HIT);
...
properties:
 ...
 // Dk
 50 BOOL m_bRenderParticles = TRUE,
...
// ********** PROJECTILE EXPLOSIONS **********
 ...
 111 model   MDL_EXPLOSION01          "Models\\Effects\\Explosion01\\Explosion01.mdl",
 112 model   MDL_PLANE_EXPLOSION01    "Models\\Effects\\Explosion01\\Explosion013D.mdl",
 113 texture TXT_EXPLOSION01          "Models\\Effects\\Explosion01\\Texture.tex",
 114 model   MDL_EXPLOSION02          "Models\\Effects\\Explosion02\\Explosion02.mdl",
 115 model   MDL_PLANE_EXPLOSION02    "Models\\Effects\\Explosion02\\Explosion023D.mdl",
 116 texture TXT_EXPLOSION02          "Models\\Effects\\Explosion02\\Texture.tex",
 117 model   MDL_EXPLOSION03          "Models\\Effects\\Explosion03\\Explosion03.mdl",
 118 model   MDL_PLANE_EXPLOSION03    "Models\\Effects\\Explosion03\\Explosion033D.mdl",
 119 texture TXT_EXPLOSION03          "Models\\Effects\\Explosion03\\Texture.tex",
 120 model   MDL_EXPLOSION04          "Models\\Effects\\Explosion04\\Explosion04.mdl",
 121 model   MDL_PLANE_EXPLOSION04    "Models\\Effects\\Explosion04\\Explosion043D.mdl",
 122 texture TXT_EXPLOSION04          "Models\\Effects\\Explosion04\\Texture.tex",

 123 model   MDL_DB_EXPLOSION         "Models\\Effects\\DBExplosion\\Explosion.mdl",
 124 texture TXT_DB_EXPLOSION         "Models\\Effects\\DBExplosion\\Explosion.tex",
 125 sound   SOUND_DB_EXPLOSION       "Models\\Effects\\DBExplosion\\Explosion.wav",

 126 model   MDL_NUKE_EXPLOSION       "Models\\Effects\\NukeExplosion\\Explosion.mdl",
 127 texture TXT_NUKE_EXPLOSION       "Models\\Effects\\NukeExplosion\\Explosion.tex",
 128 sound   SOUND_NUKE_EXPLOSION     "Models\\Effects\\DBExplosion\\Explosion.wav",
...
// ********** LASER WAVE **********
 ...
 51 texture TEXTURE_LASERWAVE     "Models\\Weapons\\Laser\\Projectile\\PlasmaWave.tex",
...
// ********** KNIFE HIT **********
 110 texture TEXTURE_KNIFE_IMPACT      "Models\\Weapons\\Knife\\Projectile\\KnifeProjectileHit2.tex",
...
/* RENDER PARTICLES */
  ...
  void RenderParticles(void)
  {
		if (m_bRenderParticles) {
			...
			if(m_betType==BET_BOMB)
			{
				Particles_ExplosionDebris1(this, m_tmSpawn, m_vStretch, m_colMultiplyColor);
				Particles_ExplosionDebris3(this, m_tmSpawn, m_vStretch, m_colMultiplyColor);
				Particles_ExplosionDebris4(this, m_tmSpawn, m_vStretch, C_lBLUE|CT_OPAQUE);
				Particles_ExplosionSmoke(this, m_tmSpawn, m_vStretch, m_colMultiplyColor);
			}
			if(m_betType==BET_GRENADE)
			{
				Particles_ExplosionDebris1(this, m_tmSpawn, m_vStretch, m_colMultiplyColor);
				Particles_ExplosionDebris3(this, m_tmSpawn, m_vStretch, m_colMultiplyColor);
				Particles_ExplosionDebris4(this, m_tmSpawn, m_vStretch, C_lRED|CT_OPAQUE);
				Particles_ExplosionSmoke(this, m_tmSpawn, m_vStretch, m_colMultiplyColor);
			}
			if(m_betType==BET_EXPLOSION_DEBRIS2)
			{
				Particles_ExplosionDebris1(this, m_tmSpawn, m_vStretch, m_colMultiplyColor);
			}
			if(m_betType==BET_KAMI_EXPLOSION)
			{
				// Rocks
				Particles_ExplosionDebris1(this, m_tmSpawn, m_vStretch, m_colMultiplyColor);
				// Sparks
			...
			if(m_betType==BET_IMPLOSION)
			{
				Particles_ExplosionDebris3(this, m_tmSpawn, m_vStretch, m_colMultiplyColor);
				//Particles_Implosion(this, m_tmSpawn, m_vStretch, m_colMultiplyColor);
			}
		} 
  }
 ...
 ************************************************************/
  ...
  void RandomHeading(void)
  {
    CPlacement3D pl = GetPlacement();
    pl.pl_OrientationAngle(1) = FRnd()*360.0f;
    SetPlacement(pl);
  };
 ...
 ************************************************************/
  ...
  void BombExplosion(void) {
    ...
    m_soEffect.Set3DParameters(25.0f*fSizeFactor, 5.0f*fSizeFactor, 1.0f*fSizeFactor, 1.0f);
    PlaySound(m_soEffect, SOUND_EXPLOSION, SOF_3D);
    m_fSoundTime = GetSoundLength(SOUND_EXPLOSION);
    m_fWaitTime = 0.3f;
		m_fFadeTime = 0.2f;
  ...
  void Explosion01(void)
  {
    SetPredictable(TRUE);
    Stretch();
    SetModel(MDL_EXPLOSION01);
    SetModelMainTexture(TXT_EXPLOSION01);
    RandomBanking();
    SetNonLoopingTexAnims();
    m_soEffect.Set3DParameters(150.0f, 3.0f, 0.25f, 1.0f);
    PlaySound(m_soEffect, SOUND_EXPLOSION, SOF_3D);
    m_fSoundTime = GetSoundLength(SOUND_EXPLOSION);
    m_fWaitTime = 0.85f;
    m_bLightSource = FALSE;
  ...
  void PlaneExplosion01(void) {
    SetPredictable(TRUE);
    Stretch();
    SetModel(MDL_PLANE_EXPLOSION01);
    SetModelMainTexture(TXT_EXPLOSION01);
    SetNormalWithRandomBanking();
    SetNonLoopingTexAnims();
    m_fWaitTime = 0.85f;
  ...
  void Explosion02(void)
  {
    SetPredictable(TRUE);
    Stretch();
    SetModel(MDL_EXPLOSION02);
    SetModelMainTexture(TXT_EXPLOSION02);
    RandomBanking();
    SetNonLoopingTexAnims();
    m_soEffect.Set3DParameters(150.0f, 3.0f, 0.25f, 1.0f);
    PlaySound(m_soEffect, SOUND_EXPLOSION, SOF_3D);
  ...
  void PlaneExplosion02(void) {
    SetPredictable(TRUE);
    Stretch();
    SetModel(MDL_PLANE_EXPLOSION02);
    SetModelMainTexture(TXT_EXPLOSION02);
    SetNormalWithRandomBanking();
    SetNonLoopingTexAnims();
    m_fWaitTime = 0.85f;
  ...
  void Explosion03(void)
  {
    SetPredictable(TRUE);
    Stretch();
    SetModel(MDL_EXPLOSION03);
    SetModelMainTexture(TXT_EXPLOSION03);
    RandomBanking();
    SetNonLoopingTexAnims();
    m_soEffect.Set3DParameters(150.0f, 3.0f, 0.25f, 1.0f);
    PlaySound(m_soEffect, SOUND_EXPLOSION, SOF_3D);
  ...
  void PlaneExplosion03(void) {
    SetPredictable(TRUE);
    Stretch();
    SetModel(MDL_PLANE_EXPLOSION03);
    SetModelMainTexture(TXT_EXPLOSION01);
    SetNormalWithRandomBanking();
    SetNonLoopingTexAnims();
    m_fWaitTime = 0.85f;
  ...
  void Explosion04(void)
  {
    SetPredictable(TRUE);
    Stretch();
    SetModel(MDL_EXPLOSION04);
    SetModelMainTexture(TXT_EXPLOSION04);
    RandomBanking();
    SetNonLoopingTexAnims();
    m_soEffect.Set3DParameters(150.0f, 3.0f, 0.25f, 1.0f);
    PlaySound(m_soEffect, SOUND_EXPLOSION, SOF_3D);
  ...
  void PlaneExplosion04(void) {
    SetPredictable(TRUE);
    Stretch();
    SetModel(MDL_PLANE_EXPLOSION04);
    SetModelMainTexture(TXT_EXPLOSION04);
    SetNormalWithRandomBanking();
    SetNonLoopingTexAnims();
    m_fWaitTime = 0.85f;
  ...
  void DBExplosion(void)
  {
    SetPredictable(TRUE);
    Stretch();
    SetModel(MDL_DB_EXPLOSION);
    SetModelMainTexture(TXT_DB_EXPLOSION);
    SetNormalForHalfFaceForward();
    m_soEffect.Set3DParameters(150.0f, 3.0f, 1.0f, 1.0f);
    PlaySound(m_soEffect, SOUND_DB_EXPLOSION, SOF_3D);
    m_fSoundTime = GetSoundLength(SOUND_DB_EXPLOSION);
    //m_fSoundTime = 0.3f;
    m_fWaitTime = 0.2f;
    m_fFadeTime = 0.1f;
    m_bLightSource = FALSE;
  ...
  void NukeExplosion(void)
  {
    SetPredictable(TRUE);
    Stretch();
    SetModel(MDL_NUKE_EXPLOSION);
    SetModelMainTexture(TXT_NUKE_EXPLOSION);
		GetModelObject()->StretchModel(FLOAT3D(0.8f, 0.6f, 0.8f));
		ModelChangeNotify();
    SetNormalForHalfFaceForward();
    m_soEffect.Set3DParameters(500.0f, 1.0f, 4.0f, 1.0f);
    PlaySound(m_soEffect, SOUND_NUKE_EXPLOSION, SOF_3D);
    m_fSoundTime = GetSoundLength(SOUND_NUKE_EXPLOSION);
    //m_fSoundTime = 0.3f;
    m_fWaitTime = 1.6f;
    m_fFadeTime = 0.2f;
    m_bLightSource = FALSE;
 ...
 ************************************************************/
  ...
  void CannonShockWave(void) {
    ...
    CModelObject &moShockwave = *GetModelObject();
    moShockwave.PlayAnim(SHOCKWAVE_TEXTURE_ANIM_FAST, 0);
    SetModelMainTexture(TEXTURE_CANNONSHOCKWAVE);
    moShockwave.mo_toTexture.PlayAnim(SHOCKWAVE_TEXTURE_ANIM_FAST, 0);
    SetNormal();
    m_fWaitTime = 0.2f;
    m_fFadeTime = 0.2f;
    m_bLightSource = FALSE;
  ...
  void CannonShockWaveVertical(void) {
    SetPredictable(TRUE);
    Stretch();
    SetModel(MODEL_CANNONSHOCKWAVE);
    CModelObject &moShockwave = *GetModelObject();
  ...
  void KnifeProjectileImpact(void) {
    SetPredictable(TRUE);
    SetModel(MODEL_BULLET_STAIN);
    SetModelMainTexture(TEXTURE_KNIFE_IMPACT);
  ...
  void TeleportEffect(void)
  {
    ...
    m_soEffect.Set3DParameters(40.0f*fSize, 10.0f*fSize, 1.5f, 1.0f);
  ...
  Main(ESpawnEffect eSpawn)
  {
    if (eSpawn.betType==BET_GIZMO_SPLASH_FX ||
       eSpawn.betType==BET_EXPLOSION_DEBRIS ||
			 eSpawn.betType==BET_EXPLOSION_DEBRIS2 ||
       ...
       eSpawn.betType==BET_GROWING_SWIRL ||
			 eSpawn.betType==BET_IMPLOSION ||
			 eSpawn.betType==BET_BOMB ||
			 eSpawn.betType==BET_GRENADE ||
			 eSpawn.betType==BET_KAMI_EXPLOSION ||
    ...
    switch (m_betType) {
      ...
      case BET_BULLETSTAINSNOWNOSOUND: BulletStainSnow(FALSE); break;
	    case BET_EXPLOSION01: Explosion01(); break;
	    case BET_EXPLOSION02: Explosion02(); break;
	    case BET_EXPLOSION03: Explosion03(); break;
	    case BET_EXPLOSION04: Explosion04(); break;
	    case BET_PLANE_EXPLOSION01: PlaneExplosion01(); break;
	    case BET_PLANE_EXPLOSION02: PlaneExplosion02(); break;
	    case BET_PLANE_EXPLOSION03: PlaneExplosion03(); break;
	    case BET_PLANE_EXPLOSION04: PlaneExplosion04(); break;
      case BET_KNIFE_IMPACT: KnifeProjectileImpact(); break;
      case BET_DB_EXPLOSION: DBExplosion(); break;
			case BET_CANNONSHOCKWAVE_VERT: CannonShockWaveVertical(); break;
			case BET_NUKE_EXPLOSION: NukeExplosion(); break;
			case BET_EXPLOSION_DEBRIS2: ExplosionDebris2(); break;
			case BET_KAMI_EXPLOSION: KamiExplosion(); break;
      default:
