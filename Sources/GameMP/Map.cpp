...
static CTextureObject atoIcons_FE[15];
static CTextureObject _toPathDot_FE;
static CTextureObject _toMapBcgLD_FE;
static CTextureObject _toMapBcgLU_FE;
static CTextureObject _toMapBcgRD_FE;
static CTextureObject _toMapBcgRU_FE;

PIX aIconCoords_FE[][2] =
{
  {175,404},  // 00: Hatshepsut
  {60,381},   // 01: Sand Canyon
  {50,300},   // 02: Ramses
...
INDEX  aPathPrevNextLevels_FE[][2] = 
{
  {HATSHEPSUT_BIT, SAND_BIT},     // 00
  {SAND_BIT, RAMSES_BIT},         // 01
  {RAMSES_BIT, CANYON_BIT},       // 02
...
BOOL ObtainMapData_FE(void)
{
  try {
    atoIcons_FE[ 0].SetData_t(CTFILENAME("Textures\\Computer\\Map\\Level00.tex"));
    atoIcons_FE[ 1].SetData_t(CTFILENAME("Textures\\Computer\\Map\\Level01.tex"));
    atoIcons_FE[ 2].SetData_t(CTFILENAME("Textures\\Computer\\Map\\Level02.tex"));
    atoIcons_FE[ 3].SetData_t(CTFILENAME("Textures\\Computer\\Map\\Level03.tex"));
    atoIcons_FE[ 4].SetData_t(CTFILENAME("Textures\\Computer\\Map\\Level04.tex"));
    atoIcons_FE[ 5].SetData_t(CTFILENAME("Textures\\Computer\\Map\\Level05.tex"));
    atoIcons_FE[ 6].SetData_t(CTFILENAME("Textures\\Computer\\Map\\Level06.tex"));
    atoIcons_FE[ 7].SetData_t(CTFILENAME("Textures\\Computer\\Map\\Level07.tex"));
    atoIcons_FE[ 8].SetData_t(CTFILENAME("Textures\\Computer\\Map\\Level08.tex"));
    atoIcons_FE[ 9].SetData_t(CTFILENAME("Textures\\Computer\\Map\\Level09.tex"));
    atoIcons_FE[10].SetData_t(CTFILENAME("Textures\\Computer\\Map\\Level10.tex"));
    atoIcons_FE[11].SetData_t(CTFILENAME("Textures\\Computer\\Map\\Level11.tex"));
    atoIcons_FE[12].SetData_t(CTFILENAME("Textures\\Computer\\Map\\Level12.tex"));
    atoIcons_FE[13].SetData_t(CTFILENAME("Textures\\Computer\\Map\\Level13.tex"));
    atoIcons_FE[14].SetData_t(CTFILENAME("Textures\\Computer\\Map\\Level14.tex"));
    _toPathDot_FE  .SetData_t(CTFILENAME("Textures\\Computer\\Map\\PathDot.tex"));
    _toMapBcgLD_FE .SetData_t(CTFILENAME("Textures\\Computer\\Map\\MapBcgLD.tex"));
    _toMapBcgLU_FE .SetData_t(CTFILENAME("Textures\\Computer\\Map\\MapBcgLU.tex"));
    _toMapBcgRD_FE .SetData_t(CTFILENAME("Textures\\Computer\\Map\\MapBcgRD.tex"));
    _toMapBcgRU_FE .SetData_t(CTFILENAME("Textures\\Computer\\Map\\MapBcgRU.tex"));
    // force constant textures
    ((CTextureData*)atoIcons_FE[ 0].GetData())->Force(TEX_CONSTANT);
    ((CTextureData*)atoIcons_FE[ 1].GetData())->Force(TEX_CONSTANT);
    ((CTextureData*)atoIcons_FE[ 2].GetData())->Force(TEX_CONSTANT);
    ((CTextureData*)atoIcons_FE[ 3].GetData())->Force(TEX_CONSTANT);
    ((CTextureData*)atoIcons_FE[ 4].GetData())->Force(TEX_CONSTANT);
    ((CTextureData*)atoIcons_FE[ 5].GetData())->Force(TEX_CONSTANT);
    ((CTextureData*)atoIcons_FE[ 6].GetData())->Force(TEX_CONSTANT);
    ((CTextureData*)atoIcons_FE[ 7].GetData())->Force(TEX_CONSTANT);
    ((CTextureData*)atoIcons_FE[ 8].GetData())->Force(TEX_CONSTANT);
    ((CTextureData*)atoIcons_FE[ 9].GetData())->Force(TEX_CONSTANT);
    ((CTextureData*)atoIcons_FE[10].GetData())->Force(TEX_CONSTANT);
    ((CTextureData*)atoIcons_FE[11].GetData())->Force(TEX_CONSTANT);
    ((CTextureData*)atoIcons_FE[12].GetData())->Force(TEX_CONSTANT);
    ((CTextureData*)atoIcons_FE[13].GetData())->Force(TEX_CONSTANT);
    ((CTextureData*)atoIcons_FE[14].GetData())->Force(TEX_CONSTANT);
    ((CTextureData*)_toPathDot_FE  .GetData())->Force(TEX_CONSTANT);
    ((CTextureData*)_toMapBcgLD_FE .GetData())->Force(TEX_CONSTANT);
    ((CTextureData*)_toMapBcgLU_FE .GetData())->Force(TEX_CONSTANT);
    ((CTextureData*)_toMapBcgRD_FE .GetData())->Force(TEX_CONSTANT);
...
void ReleaseMapData_FE(void)
{
  atoIcons_FE[0].SetData(NULL);
  atoIcons_FE[1].SetData(NULL);
  atoIcons_FE[2].SetData(NULL);
  atoIcons_FE[3].SetData(NULL);
  atoIcons_FE[4].SetData(NULL);
  atoIcons_FE[5].SetData(NULL);
  atoIcons_FE[6].SetData(NULL);
  atoIcons_FE[7].SetData(NULL);
  atoIcons_FE[8].SetData(NULL);
  atoIcons_FE[9].SetData(NULL);
  atoIcons_FE[10].SetData(NULL);
  atoIcons_FE[11].SetData(NULL);
  atoIcons_FE[12].SetData(NULL);
  atoIcons_FE[13].SetData(NULL);
  atoIcons_FE[14].SetData(NULL);
  _toPathDot_FE.SetData(NULL);
  _toMapBcgLD_FE.SetData(NULL);
  _toMapBcgLU_FE.SetData(NULL);
  _toMapBcgRD_FE.SetData(NULL);
  _toMapBcgRU_FE.SetData(NULL);
}

void RenderMap_FE( CDrawPort *pdp, ULONG ulLevelMask, CProgressHookInfo *pphi)
{
  if( !ObtainMapData_FE())
  {
    ReleaseMapData_FE();
  ...
  pdp->PutTexture( &_toMapBcgLU_FE, PIXaabbox2D( PIX2D(pixC1S,pixR1S), PIX2D(pixC1E,pixR1E)), C_WHITE|255);
  pdp->PutTexture( &_toMapBcgRU_FE, PIXaabbox2D( PIX2D(pixC2S,pixR1S), PIX2D(pixC2E,pixR1E)), C_WHITE|255);
  pdp->PutTexture( &_toMapBcgLD_FE, PIXaabbox2D( PIX2D(pixC1S,pixR2S), PIX2D(pixC1E,pixR2E)), C_WHITE|255);
  pdp->PutTexture( &_toMapBcgRD_FE, PIXaabbox2D( PIX2D(pixC2S,pixR2S), PIX2D(pixC2E,pixR2E)), C_WHITE|255);
 
  // render icons
  for( INDEX iIcon=0; iIcon<ARRAYCOUNT(aIconCoords_FE); iIcon++)
  {
    // if level's icon should be rendered
    if( ulLevelMask & (1UL<<iIcon))
    {
      PIX pixX = aIconCoords_FE[iIcon][0]*fStretch+pixC1S;
      PIX pixY = aIconCoords_FE[iIcon][1]*fStretch+pixR1S;
      CTextureObject *pto = &atoIcons_FE[iIcon];
  ...
  // render paths
  for( INDEX iPath=0; iPath<ARRAYCOUNT(aPathPrevNextLevels_FE); iPath++)
  {
    INDEX iPrevLevelBit = aPathPrevNextLevels_FE[iPath][0];
    INDEX iNextLevelBit = aPathPrevNextLevels_FE[iPath][1];
        ...
        ((iNextLevelBit-iPrevLevelBit)==1 || !(ulLevelMask&(1UL<<(iNextLevelBit-1)))))
    {
      for( INDEX iDot=0; iDot<10; iDot++)
      {
        PIX pixDotX=pixC1S+aPathDots_FE[iPath][iDot][0]*fStretch;
        PIX pixDotY=pixR1S+aPathDots_FE[iPath][iDot][1]*fStretch;
        if(aPathDots_FE[iPath][iDot][0]==-1) break;
        pdp->PutTexture( &_toPathDot_FE, PIXaabbox2D( PIX2D(pixDotX, pixDotY), PIX2D(pixDotX+8*fStretch, pixDotY+8*fStretch)),
          C_WHITE|255);
      }
    }
  }
  ...
  if( pphi != NULL)
  {
    ...
    COLOR colText = 0x6e4320ff; //RGBToColor(200,128,56)|CT_OPAQUE;
    pdp->PutTextC( pphi->phi_strDescription, pixhtcx, pixhtcy, colText);
    for( INDEX iProgresDot=0; iProgresDot<16; iProgresDot+=1)
    {
      ...
      pdp->PutTexture( &_toPathDot_FE, PIXaabbox2D( PIX2D(pixDotX, pixDotY), 
        PIX2D(pixDotX+8*fStretch, pixDotY+8*fStretch)), colDot);
    }
  }
